    ...
    <Card className="border border-neutral-800 bg-neutral-900/80 p-4 sm:p-5 space-y-4">
      <div className="flex items-center justify-between gap-3">
        ...
        <Button
          variant="outline"
          size="sm"
          className="rounded-xl border-neutral-700 text-xs text-neutral-200 hover:bg-neutral-800"
          onClick={loadRides}
          disabled={loading}
        >
          {loading ? (
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    ...
                    {ride.Status === "Scheduled" && (
                      <Button
                        size="sm"
                        className="rounded-xl bg-emerald-500 text-xs font-semibold text-neutral-950 hover:bg-emerald-400"
                    ...
                    {ride.Status === "InProgress" && (
                      <Button
                        size="sm"
                        variant="outline"
                        className="rounded-xl border-red-500/60 text-xs font-semibold text-red-300 hover:bg-red-500/10"

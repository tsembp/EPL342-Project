    ...
    async function loadHistory() {
      ...
      try {
        ...
        const res = await fetch(
          `/api/passenger/ride-history?${params.toString()}`
        );
                  ...
                  >
                        ...
                        <>
                          <div className="flex items-center gap-2">
                            ...
                            <span>
                              ...
                              {item.TotalRides && item.TotalRides > 1 ? "s" : ""} ·{" "}
                              {new Date(item.FirstRideStartedAt as string).toLocaleString()} –{" "}
                              {new Date(item.LastRideEndedAt as string).toLocaleString()}
                            </span>
                          </div>
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          navigate(`/passenger/rides/${item.RequestId}/details`)
                        }
                      >
                        View details
              ...
              {totalPages > 1 && (
                <div className="mt-2 flex items-center justify-between text-xs text-neutral-400">
                  <span>
                    ...
                    of{" "}
                    <span className="text-neutral-100">{totalItems}</span>{" "}
                    trips
                  </span>
                  <div className="flex items-center gap-2">
                    <Button
                    ...
                    <span className="text-[11px] text-neutral-400">
                      Page{" "}
                      <span className="text-neutral-100">{clampedPage}</span>{" "}
                      of{" "}
